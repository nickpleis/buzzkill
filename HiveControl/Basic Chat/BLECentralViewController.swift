...
class BLECentralViewController : UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate, UITableViewDelegate, UITableViewDataSource{
    ...
    @IBOutlet weak var connectAll: UIBarButtonItem!
    ...
    func disconnectFromDevice () {
        ...
        var totalDevices = peripherals.count
        var count = 0
        
        while count < totalDevices
        {
            blePeripheral = peripherals[count]
    ...
    func disconnectAllConnection() {
        ...
        {
            blePeripheral = peripherals[counter]
            centralManager?.cancelPeripheralConnection(blePeripheral!)
            counter = counter + 1
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverCharacteristicsFor service: CBService, error: Error?) {
        ...
        for characteristic in characteristics {
            ...
            if characteristic.uuid.isEqual(BLE_Characteristic_uuid_Tx){
                ...
                txArray.append(characteristic)
                mapArray.append(peripheral.identifier.uuidString)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        uartViewController.peripheral = blePeripheral
        uartViewController.peripheralsArray = peripherals
    ...
    @IBAction func connectAll(_ sender: UIButton) {
        
        print("connect All clicked")
        var totalDevices = peripherals.count
        indexCounter = 0
        
        while indexCounter < totalDevices
        {
            blePeripheral = peripherals[indexCounter]
            print (blePeripheral)
            connectToDevice()
        ...
        //uartViewController.peripheral = blePeripheral
        uartViewController.numOfPeripherals = totalDevices
        uartViewController.peripheralsArray = peripherals
